...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <main className="mx-auto max-w-md px-6 py-16">
      <h1 className="text-2xl font-semibold text-neutral-900 dark:text-neutral-100">Log in</h1>
      ...
      {cameFromProtectedRoute ? (
        ...
        <p className="mt-2 text-sm text-neutral-600 dark:text-neutral-400">
          Sign in to your NetPDBFF account.
        </p>
      )}
      ...
      <div className="mt-6 flex flex-col gap-2 text-sm text-neutral-600 dark:text-neutral-400">
        <p>
